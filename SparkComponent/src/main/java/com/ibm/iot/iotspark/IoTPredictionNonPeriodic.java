...
public class IoTPredictionNonPeriodic extends IoTPrediction {
    ...
    public void appendDataSet(JSONObject obj) throws JSONException {
        double d = obj.getDouble("vibration");
    ...
    public String predict(String s) throws Exception {
       ...
       //put device vibration string into prediction dataset
       if (obj.has("name")&&obj.get("name") != null &&
           obj.has("vibration") && obj.get("vibration") != null )  {
           appendDataSet(obj);
           ...
           if (this.count == 1) {
	           ...
	           * [{"header":["vibration","field3","$TI_TimeIndex","$TI_TimeLabel","$TI_Cycle","$TI_Period","$TI_Future","$TS-vibration","$TSLCI-vibration","$TSUCI-vibration"],
          ...
          if (pa.isNull(this.count-1) == true) {
	          ...
	          //$TS-vibration is the 7th in the array
	          ...
	          double current = obj.getDouble("vibration");
    ...
    public static void main(String[] args) {
      ...
      final List<String> input = Arrays.asList(
    		  "{\"name\":\"datacenter\",\"vibration\":17.47}",
    		  "{\"name\":\"datacenter\",\"vibration\":17.47}",
    		  "{\"name\":\"datacenter\",\"vibration\":17.44}",
    		  "{\"name\":\"datacenter\",\"vibration\":17.44}",
    		  "{\"name\":\"datacenter\",\"vibration\":17.38}",
    		  "{\"name\":\"datacenter\",\"vibration\":17.44}",
    		  "{\"name\":\"datacenter\",\"vibration\":17.47}",
    		  "{\"name\":\"datacenter\",\"vibration\":17.5}",
    		  "{\"name\":\"datacenter\",\"vibration\":17.5}",
    		  "{\"name\":\"datacenter\",\"vibration\":17.5}",
    		  "{\"name\":\"datacenter\",\"vibration\":17.5}",
    		  "{\"name\":\"datacenter\",\"vibration\":17.5}",
    		  "{\"name\":\"datacenter\",\"vibration\":17.56}",
    		  "{\"name\":\"datacenter\",\"vibration\":17.56}",
    		  "{\"name\":\"datacenter\",\"vibration\":17.53}",
    		  "{\"name\":\"datacenter\",\"vibration\":17.5}",
		      "{\"name\":\"datacenter\",\"vibration\":17.53}",
    		  "{\"name\":\"datacenter\",\"vibration\":17.5}",
    		  "{\"name\":\"datacenter\",\"vibration\":17.53}",
    		  ...
    		  "{\"name\":\"datacenter\",\"vibration\":17.47}",
    		  "{\"name\":\"datacenter\",\"vibration\":17.47}",
    		  "{\"name\":\"datacenter\",\"vibration\":17.41}",
    		  "{\"name\":\"datacenter\",\"vibration\":17.42}"
      );
